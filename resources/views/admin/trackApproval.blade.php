    ...
    <div class="flex-1 flex flex-col w-full">
        ...
        <main class="flex-1 p-6 " id="main-content">
            <div class="w-full">
                ...
                <h1 class="text-3xl font-bold pb-4 py-2 tracking-wide max-lg:text-center">Track Approval</h1>
                ...
                <div class="grid gap-6 shadow-xl rounded-xl">
                    ...
                    <div class="mx-auto px-4 w-full max-[520px]:max-w-[600px]  max-sm:flex-col flex gap-4 items-center justify-center py-8">
                        <a href="{{route("admin.approveUser", $id->id)}}" class="px-10 py-3 rounded-md text-center border-none text-lg text-white shadow bg-[#624E88] hover:bg-[#58457b]">Approve</a>
